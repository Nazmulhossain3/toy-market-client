...
const Banner = () => {
    return (
        <div className="hero mx-auto p-6">
        <div className="hero-content flex-col lg:flex-row">
          <img src="https://cdn.zeebiz.com/sites/default/files/2023/02/09/226456-teddy-day.jpg" className="max-w-sm rounded-lg shadow-2xl" />
          <div className='p-6'>
